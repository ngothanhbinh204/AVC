...
<section class="product-list section xl:pt-20 pb-0">
        ...
        <div class="container">
            <div class="spy-nav-menu normal-nav sticky-nav">
                <nav class="justify-center flex items-center">
                    <ul>
                        <?php foreach ($has_child as $key => $value) : ?>
                            <li>
    ...
    <div class="boards absolute w-full bottom-0 right-0">
        <div class="wrapper relative h-0 overflow-hidden">
            <div class="absolute swiper-column-auto allow-touchMove auto-play inset-0 swiper-loop" data-time=2000>
                <div class="swiper w-full h-full">
                    <div class="swiper-wrapper w-full h-full">
                        ...
                        <?php foreach ($gallery_swiper as $image) : ?>
                            <?php if ($key_image < 3) : ?> <!-- Hiển thị tối đa 3 ảnh -->
...
<?php endif; ?>
                        ...
                        <?php if ($the_query->have_posts()) : ?>
                            <div class="child-category auto-scroll-nav border-y border-primary-500 my-8 lg:my-10" id="child-category">
                                <div class="container">
                                        ...
                                        <nav class="flex items-center justify-center">
                                            <ul class="flex items-center overflow-auto">
                                                <?php if ($the_query->have_posts()) : while ($the_query->have_posts()) : $the_query->the_post(); ?>
                                                        <li>
                                                            <a class="text-18px sm:subheader-24 font-bold text-neutral-900 transition-all relative flex items-center py-3 sm:py-5 whitespace-nowrap" href="javascript:;"><?= get_the_title($id) ?></a>
                                                        </li>
                                                <?php endwhile;
                                                endif;
                                                wp_reset_postdata(); ?>
                        ...
                        <div class="swiper-wrapper">
                            <?php foreach ($videos as $value) : ?>
                                ...
                                <div class="swiper-slide relative <?php if ($video) : ?> has-youtube-video <?php endif; ?>" <?php if ($video) : ?>data-embed="<?= $video ?>" <?php endif; ?>>
                                    ...
                                    <?php endif; ?>
                                    <div class="img"><a href="javascript:;" rel="nofollow"><?= custom_lozad_image($value['image']) ?></a>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
                        ...
                        <div class="swiper-wrapper">
                            <?php foreach ($protocols as $value) : ?>
                                <div class="swiper-slide relative">
                                    <div class="item py-4 lg:py-50px px-3 h-full flex items-center justify-center" setbackground="<?php bloginfo("template_directory"); ?>/img/home/h-5-i-bg.webp">
