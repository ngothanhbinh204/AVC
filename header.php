                    ...
                    <div class="top flex items-center gap-3 xl:gap-6">
                        <div class="search-wrapper">
                            <div class="search-overlay" id="search-overlay">
                                <form class="searchbox flex" id="searchForm" action="<?php bloginfo('url') ?>/" method="GET" role="form">
                                    <input placeholder="<?php _e('Tìm kiếm', 'canhcamtheme'); ?>" type="text" name="s" />
                                    <button><i class="fa-light fa-magnifying-glass text-16px text-primary-5"></i></button>
                                </form>
                            </div>
                        ...
                        <div class="desktop-show">
                            <div id="autoClone-HeaderHotline" class="flex items-center gap-1">
                                <!-- <a class="hotline flex items-center gap-2 rounded-tl-6 rounded-br-6 bg-primary-1 text-white text-16px leading-1.25 py-3 xl:py-6px px-6 text-center justify-center">
                                    <i class="fa-light fa-phone-volume text-16px -rotate-45"></i>Hotline:<strong>0210
                                        3888 399</strong></a> -->
                                <?= $header['hot_line'] ?>
                            </div>
                        </div>
